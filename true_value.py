...
for num in  range(1,64):
    ...
    if json_validate['data'] !=[]:
        for collect_id in json_validate['data']:
            ...
            # product_name = 'Do it Best Mini Shelving 4-Layer C1037#1'
            title_lower = product_name.lower().replace(' ','-')
            # id_of_product = '323892'
            # breakpoint()

            product_url = f'https://gocart.ph/handyman/product/{title_lower}?buId=4&productId={id_of_product}&storeCode=503&zoneNum=2&isGoSubscribe=false'
